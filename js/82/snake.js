(function () {
    ...
    class Snake {
        ...
        move() {
            ...
            if (this.x  < 0 || this.x + SNAKE_SIZE >= theCanvas.width || this.y  < 0 || this.y + SNAKE_SIZE >= theCanvas.height) {
                gameover = true;
            }
    ...
    function game() {
        ...
        context.drawImage(apple, theCanvas.width - 200, 10, 40, 40)
        context.font = '30px Arial';
        context.fillStyle = 'red'
        context.fillText(score, theCanvas.width - 150, 40);
